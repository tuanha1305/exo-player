...
import io.github.tuanictu97.exo.core.audio.Ac3Util.SyncFrameInfo.StreamType;
...
public final class Ac3Util {
  ...
  public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray data) {
    ...
    @Nullable String mimeType;
    @SyncFrameInfo.StreamType int streamType = SyncFrameInfo.STREAM_TYPE_UNDEFINED;
    int sampleRate;
    int acmod;
    int frameSize;
    int sampleCount;
