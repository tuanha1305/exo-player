 ...
 */
package io.github.tuanictu97.exo.core.mediacodec;
...
import io.github.tuanictu97.exo.core.util.TimedValueQueue;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "io.github.tuanictu97.exo.core.mediacodec.MediaCodecRenderer_"
          + sign
          + Math.abs(errorCode);
    }
  }
