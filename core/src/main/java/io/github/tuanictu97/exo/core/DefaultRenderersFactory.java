...
import io.github.tuanictu97.exo.core.audio.AudioCapabilities;
import io.github.tuanictu97.exo.core.audio.AudioProcessor;
import io.github.tuanictu97.exo.core.audio.AudioRendererEventListener;
import io.github.tuanictu97.exo.core.audio.DefaultAudioSink;
import io.github.tuanictu97.exo.core.audio.MediaCodecAudioRenderer;
import io.github.tuanictu97.exo.core.drm.DrmSessionManager;
import io.github.tuanictu97.exo.core.drm.FrameworkMediaCrypto;
import io.github.tuanictu97.exo.core.mediacodec.MediaCodecSelector;
import io.github.tuanictu97.exo.core.metadata.MetadataOutput;
import io.github.tuanictu97.exo.core.metadata.MetadataRenderer;
import io.github.tuanictu97.exo.core.text.TextOutput;
import io.github.tuanictu97.exo.core.text.TextRenderer;
import io.github.tuanictu97.exo.core.trackselection.TrackSelector;
import io.github.tuanictu97.exo.core.util.Log;
import io.github.tuanictu97.exo.core.video.MediaCodecVideoRenderer;
import io.github.tuanictu97.exo.core.video.VideoRendererEventListener;
import io.github.tuanictu97.exo.core.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("io.github.tuanictu97.exo.core.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
              io.github.tuanictu97.exo.core.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("io.github.tuanictu97.exo.core.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("io.github.tuanictu97.exo.core.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              io.github.tuanictu97.exo.core.audio.AudioRendererEventListener.class,
              io.github.tuanictu97.exo.core.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("io.github.tuanictu97.exo.core.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              io.github.tuanictu97.exo.core.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("io.github.tuanictu97.exo.core.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              io.github.tuanictu97.exo.core.audio.AudioRendererEventListener.class,
