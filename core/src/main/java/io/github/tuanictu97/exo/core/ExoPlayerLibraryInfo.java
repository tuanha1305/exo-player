...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link io.github.tuanictu97.exo.core.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link io.github.tuanictu97.exo.core.util.TraceUtil}
   * trace enabled.
   */
