 ...
 */
package io.github.tuanictu97.exo.core.extractor;

import io.github.tuanictu97.exo.core.extractor.amr.AmrExtractor;
import io.github.tuanictu97.exo.core.extractor.flac.FlacExtractor;
import io.github.tuanictu97.exo.core.extractor.flv.FlvExtractor;
...
import io.github.tuanictu97.exo.core.extractor.mp4.Mp4Extractor;
import io.github.tuanictu97.exo.core.extractor.ogg.OggExtractor;
import io.github.tuanictu97.exo.core.extractor.ts.Ac3Extractor;
import io.github.tuanictu97.exo.core.extractor.ts.Ac4Extractor;
import io.github.tuanictu97.exo.core.extractor.ts.AdtsExtractor;
import io.github.tuanictu97.exo.core.extractor.ts.DefaultTsPayloadReaderFactory;
import io.github.tuanictu97.exo.core.extractor.ts.PsExtractor;
import io.github.tuanictu97.exo.core.extractor.ts.TsExtractor;
import io.github.tuanictu97.exo.core.extractor.ts.TsPayloadReader;
import io.github.tuanictu97.exo.core.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("io.github.tuanictu97.exo.core.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("io.github.tuanictu97.exo.core.ext.flac.FlacExtractor")
