  ...
  static {
    ...
    try {
      ...
      dashDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("io.github.tuanictu97.exo.dash.offline.DashDownloader"));
    ...
    try {
      ...
      hlsDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("io.github.tuanictu97.exo.hls.offline.HlsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
    ...
    try {
      ...
      ssDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName(
                  "io.github.tuanictu97.exo.smoothstreaming.offline.SsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
