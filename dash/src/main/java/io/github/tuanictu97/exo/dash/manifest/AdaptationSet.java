...
public class AdaptationSet {
  ...
  /**
   * The type of the adaptation set. One of the {@link io.github.tuanictu97.exo.core.C}
   ...
   * @param type The type of the adaptation set. One of the {@link io.github.tuanictu97.exo.core.C}
   *     {@code TRACK_TYPE_*} constants.
